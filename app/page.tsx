    ...
    <div className="home-page">
      ...
      <section className="hero-section min-h-[80vh] flex flex-col items-center justify-center text-center px-4 py-16 relative">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          <Link href="/setup" className="primary-btn large-btn pulse-btn">
            <Rocket className="h-5 w-5" />
            ابدأ الآن
          </Link>
          <Link href="/models" className="secondary-btn large-btn">
            ...
            <div className="models-carousel flex gap-6 overflow-x-auto pb-6 snap-x">
              ...
              <div className="model-card min-w-[300px] max-w-[300px] bg-background-light rounded-lg overflow-hidden border border-background-lighter flex flex-col snap-center">
                ...
                <div className="model-footer p-4 border-t border-background-lighter">
                  <Link href="/models/deepseek" className="primary-btn w-full justify-center">
                    استخدم النموذج
                  </Link>
                </div>
              </div>
              ...
              <div className="model-card min-w-[300px] max-w-[300px] bg-background-light rounded-lg overflow-hidden border border-background-lighter flex flex-col snap-center">
                ...
                <div className="model-footer p-4 border-t border-background-lighter">
                  <Link href="/models/gpt4o" className="primary-btn w-full justify-center">
                    استخدم النموذج
                  </Link>
                </div>
              </div>
              ...
              <div className="model-card min-w-[300px] max-w-[300px] bg-background-light rounded-lg overflow-hidden border border-background-lighter flex flex-col snap-center">
                ...
                <div className="model-footer p-4 border-t border-background-lighter">
                  <Link href="/models/llama2" className="primary-btn w-full justify-center">
                    استخدم النموذج
                  </Link>
                </div>
              </div>
              ...
              <div className="model-card min-w-[300px] max-w-[300px] bg-background-light rounded-lg overflow-hidden border border-background-lighter flex flex-col snap-center">
                ...
                <div className="model-footer p-4 border-t border-background-lighter">
                  <Link href="/models/tinyllama" className="primary-btn w-full justify-center">
                    استخدم النموذج
                  </Link>
                </div>
              </div>
      ...
      <section className="cta-section py-16 px-4 bg-background-darker relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl text-center relative z-10">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="/setup" className="primary-btn large-btn">
              <i className="fas fa-download mr-2"></i>
              تثبيت النظام
            </Link>
            <Link href="/chat" className="secondary-btn large-btn">
