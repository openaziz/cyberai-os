        ...
        <div className="setup-content bg-background-light p-6 rounded-lg border border-background-lighter">
                ...
                {platforms.map((platform) => (
                  ...
                  >
                    <div className="flex flex-col items-center text-center">
                      <div className="platform-icon text-3xl mb-3" style={{ color: platform.color }}>
            ...
            <div className="step-content">
              ...
              <div className="cloud-models-note bg-background p-4 rounded-lg border border-background-lighter">
                ...
                <p className="text-sm text-muted">
                  النماذج السحابية مثل DeepSeek-R1-70B وGPT-4o متاحة مباشرة من خلال واجهة الدردشة دون الحاجة للتثبيت
                  المحلي. يتطلب استخدامها اتصالاً بالإنترنت ومفاتيح API صالحة.
                </p>
              </div>
            </div>
          )}
          ...
          {activeStep === 3 && (
            <div className="step-content">
              ...
              <p className="text-muted mb-6">قم بتخصيص إعدادات CyberAI OS وفقاً لاحتياجاتك وتفضيلاتك.</p>
          ...
          {activeStep === 4 && (
            <div className="step-content">
              ...
              {installProgress < 100 ? (
                <>
                  <p className="text-muted mb-6">
                    جاري تثبيت CyberAI OS وتحميل النماذج المحددة. قد تستغرق هذه العملية بضع دقائق حسب سرعة الاتصال وحجم
                    النماذج.
                  </p>
                  ...
                  <div className="install-progress mb-8">
                    ...
                    <div className="install-status mt-4 text-sm text-muted">
                      {installProgress < 25 && <p>جاري تثبيت الملفات الأساسية...</p>}
                      {installProgress >= 25 && installProgress < 50 && (
                        <p>جاري تحميل نموذج {selectedModel || "TinyLlama"}...</p>
                      )}
                      {installProgress >= 50 && installProgress < 75 && <p>جاري تهيئة النموذج...</p>}
                      {installProgress >= 75 && installProgress < 100 && <p>جاري إكمال التثبيت...</p>}
                    </div>
                  </div>
                ...
                <div className="install-complete text-center py-8">
                  ...
                  <p className="text-muted mb-8">
                    تم تثبيت CyberAI OS بنجاح على جهازك. يمكنك الآن البدء في استخدام النظام والتفاعل مع نماذج الذكاء
                    الاصطناعي.
                  </p>
